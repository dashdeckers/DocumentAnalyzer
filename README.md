...
7. You can now edit this text file until it is correct. The spellchecker can help you do this, if you click on a red underlined word and then on one of the corrections it will replace that word. Re-run the spellchecker manually using the drop-down menu "Edit", or the keyboard shortcut "Ctrl + p". Once you are satisfied with the transcription, save the text and open the next pdf using the drop-down menu "Edit" or the keyboard shortcut "Ctrl + n".
